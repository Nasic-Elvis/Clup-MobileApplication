  ...
  Future<bool> checkUserLogged() async {
    ...
    if (prefs.getString("idUser") != "" && prefs.getString("idUser") != null) {
      BlocProvider.of<AuthenticationBloc>(context)
          .add(Login(prefs.getString("email"), prefs.getString("password")));
      return true;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
              _currentIndex == 0
                  ? AppLocalizations.of(context).homepage_appBar_text_title
                  : _currentIndex == 1
                      ? AppLocalizations.of(context)
                          .homepage_appBar_text_preferences
                      : _currentIndex == 2
                          ? AppLocalizations.of(context)
                              .homepage_appBar_text_booking
                          : AppLocalizations.of(context)
                              .homepage_appBar_text_settings,
              style: TextStyle(
                  color: Colors.black,
                  fontSize: 16,
                                        ...
                                        return Center(
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                AppLocalizations.of(context)
                                                    .homepage_noStore_category_markets,
                                                style: TextStyle(
                                                    color: Colors.black
                                                        .withOpacity(0.8),
                                                    fontWeight:
                                        ...
                                        return Center(
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                AppLocalizations.of(context)
                                                    .homepage_noStore_category_services,
                                                style: TextStyle(
                                                    color: Colors.black
                                                        .withOpacity(0.8),
                                                    fontWeight:
                                        ...
                                        return Center(
                                          child: Column(
                                            children: [
                                              ...
                                              Text(
                                                AppLocalizations.of(context)
                                                    .homepage_noStore_category_health,
                                                style: TextStyle(
                                                    color: Colors.black
                                                        .withOpacity(0.8),
                                                    fontWeight:
                ...
                onTap: () {
                  ...
                  if (_cityController.text == values.Strings.empty &&
                    ...
                    _cityController.text =
                        AppLocalizations.of(context).homepage_city_error;
                  } else {
